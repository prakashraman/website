  ...
  return (
    <div className="">
      ...
      <div className="h-[56px]">
        <input
          className="text-l h-full w-[180px] rounded-full border border-gray-300 pl-4 outline-none focus:border-gray-800 lg:w-[500px] lg:pl-8"
        ...
        <button
          ...
          className="text-l ml-2 h-full rounded-full bg-gray-800 pl-10 pr-10 text-white disabled:bg-gray-200 disabled:text-gray-500 lg:ml-5"
          onClick={onSubmit}
        >
          Ask
        </button>
      ...
      {options && options.length > 0 && (
        <div className="mt-4 ml-2 text-gray-600 lg:ml-4">
          <span className="text-sm">
            Tap one to view the recommendation or hit "ask"
          </span>
        </div>
      )}
